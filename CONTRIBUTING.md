Contributing to SlicerCustomExample
===============================

There are many ways to contribute to SlicerCustomExample.

  * Submit a feature request or bug, or add to the discussion on the [SlicerCustomExample issue tracker][is]
  * Submit a [Pull Request][pr] to improve SlicerCustomExample.
...
If you are new to SlicerCustomExample development and you don't have push access to the SlicerCustomExample
...
When submitting a PR, make sure to add a `Cc: @SlicerCustomExample/developers` comment to
notify SlicerCustomExample developers of your awesome contributions. Based on the
...
* You do NOT have push access: A SlicerCustomExample core developer will integrate your PR.
...
[pr]: https://github.com/Kitware/SlicerCustomExample/merge_requests
[is]: https://github.com/Kitware/SlicerCustomExample/issues
